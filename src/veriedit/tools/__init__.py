...
def build_tool_registry() -> ToolRegistry:
    ...
    registry.register(
        ToolSpec(
            ...
            edit_scope="global",
            capability_tags=["color_cast", "tone"],
    ...
    registry.register(
        ToolSpec(
            ...
            edit_scope="local",
            capability_tags=["dust", "local_repair"],
    ...
    registry.register(
        ToolSpec(
            ...
            edit_scope="local",
            capability_tags=["scratch", "local_repair"],
    ...
    registry.register(
        ToolSpec(
            ...
            edit_scope="local",
            capability_tags=["dust", "scratch", "local_repair"],
    ...
    registry.register(
        ToolSpec(
            ...
            edit_scope="global",
            capability_tags=["reference", "tone"],
    ...
    registry.register(
        ToolSpec(
            ...
            edit_scope="local",
            capability_tags=["paint", "local_repair", "dust", "scratch"],
            parameter_bounds={
                "stroke_budget": (1, 128),
