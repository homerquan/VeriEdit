...
class DiagnosticsAgent:
    def run(self, state: WorkflowState) -> WorkflowState:
        ...
        masks = defect_masks(source_image)
        regions = region_summary(masks)
        artifacts = save_mask_artifacts(source_image, masks, Path(state["run_dir"]) / "diagnostics")
        ...
        self._log(
            ...
            AgentLog(
                ...
                decision="diagnosed",
                output_summary={"source": diagnostics.source.model_dump(), "regions": regions, "artifacts": artifacts},
